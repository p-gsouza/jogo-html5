...
- Organizar e gerenciar o ambiente de desenvolvimento utilizando o **Visual Studio Code** e **Git/GitHub**.
- Estruturar interfaces dinâmicas e responsivas com HTML5 e CSS3.
- Utilizar os conceitos do **Canvas 2D** e animações programadas.
- Aplicar princípios de **Orientação a Objetos (POO)** para escrita de código limpo e reusável.
- Desenvolver *Game Loops*, controle de taxa de quadros e gerenciamento de estados.
- Capturar e processar eventos de teclado e controle de entrada do jogador.
- Integrar animações baseadas em *spritesheets* e manipular efeitos sonoros/música.
- Implementar algoritmos de colisão e regras de pontuação/desafio.
...
| :--- | :--- |
| **HTML5** | Estruturação da aplicação e suporte ao elemento `<canvas>` |
| **CSS3** | Estilização da interface e layout da aplicação |
| **JavaScript (ES6+)** | Lógica do jogo, movimentação, colisões e renderização |
...
- [ ] **Aula 5:** Controles do jogador
- [ ] **Aula 6:** Sprites e spritesheets
- [ ] **Aula 7:** Mecânicas de jogo e trilha sonora/áudio
- [ ] **Aula 8:** Colisões
